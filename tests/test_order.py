...
class TestOrder:
    ...
    def test_order_with_valid_credential(self, driver):
        ...
        assert self.data.successful_massage == expected_text, \
            f"Unexpected text, expected text: {expected_text}, actual text: {self.data.successful_massage}"
    ...
    def test_order_with_wrong_credential(self, driver, lst_data):
        ...
        assert lst_data[
                   3] == expected_text, f"Unexpected text, expected text: {expected_text}, actual text: {lst_data[3]}"
